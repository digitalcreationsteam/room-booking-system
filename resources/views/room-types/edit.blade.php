        ...
        <form action="{{ route('room-types.update', $roomType) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="3"
                    class="w-full px-3 py-2 border rounded focus:outline-none focus:border-blue-500">{{ old('description', $roomType->description) }}</textarea>
            </div>
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" name="is_active" value="1"
                        {{ old('is_active', $roomType->is_active) ? 'checked' : '' }} class="mr-2">
            ...
            <div class="flex gap-4">
                ...
                <a href="{{ route('room-types.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-6 py-2 rounded">
                    Cancel
                </a>
            </div>
        </form>
